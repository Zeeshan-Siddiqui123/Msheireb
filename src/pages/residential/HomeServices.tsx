    ...
    <DashboardLayout leftSidebar={leftSidebar} rightSidebar={rightSidebar}>
      <section className="flex flex-col h-full w-full max-w-3xl mx-auto px-4 py-2">
        ...
        <div className="relative flex items-center justify-center mb-1">
          ...
          <h1 className="text-xl font-bold text-white tracking-wide">My Services</h1>
        </div>
        <p className="text-sm text-white/90 mb-6 text-center">Choose a category to help us understand the problem</p>
