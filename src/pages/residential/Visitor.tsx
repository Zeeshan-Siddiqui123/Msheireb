...
import Pending from '../../components/portals/residential/Tabs/Pending';
import Active from '../../components/portals/residential/Tabs/Active';
import VisitorHistory from '../../components/portals/residential/Tabs/VisitorHistory';
                ...
                <PageHeader
                    ...
                    belowTabsContent={
                        <div className='flex justify-center -mt-5'>
                            <GlassButton className='py-1.5 px-5 bg-white/10'>+ Pre-Register Visitor</GlassButton>
                        </div>
                    }
                />
